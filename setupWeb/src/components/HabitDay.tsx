        ...
        <Popover.Root>
            <Popover.Trigger
                className={clsx("w-10 h-10 rounded-lg",
                    ...
                    {
                        'bg-zinc-900 border-2 border-zinc-800 ': completedPercentage === 0 && completedPercentage < 20,
            ...
            <Popover.Portal>
                <Popover.Content className='min-w-[320px] w-full p-6 rounded-2xl bg-zinc-900 flex flex-col'>
                    ...
                    <span className='mt-1 font-extrabold leading-tight text-3xl'>18/04</span>
                    ...
                    <div className='mt-6 flex flex-col gap-3'>
                        ...
                        <Checkbox.Root className='flex items-center gap-3 group'>
                            ...
                            <span className='font-semibold text-xl text-white leading-tight  group-data-[state=checked]:line-through group-data-[state=checked]:text-zinc-400'>
                                Engolir 2L de leite de uma vez só
                            </span>
                        </Checkbox.Root>
